...
data RuntimeDefinitions = MkRuntimeDefinitions
    ...
    , vega_debug_stack_roots :: (LLVM.Value, AttributeFunctionType)
...
declareRuntimeDefinitions module_ = do
    ...
    let vega_debug_stack_roots_type = attributeFunctionType [] (LLVM.voidType, [])
    vega_debug_stack_roots <- addFunctionWithAttributes module_ "vega_debug_stack_roots" vega_debug_stack_roots_type
    ...
    pure
        ( MkRuntimeDefinitions
            ...
            , vega_debug_stack_roots = (vega_debug_stack_roots, vega_debug_stack_roots_type)
